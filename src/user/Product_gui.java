	...
	class Product_Register extends JFrame{	
		...
		class RegisterBntAct implements ActionListener{
			...
			boolean nameChk() {
				...
				if(al.size() == 0)
					return true;
			//	System.out.println(data_gui.getSize());
			...
			public void actionPerformed(ActionEvent e) {	///상품정보를 표에 담음
				...
				if(name_gui.getText().isEmpty()&&price_gui.getText().isEmpty()
						&&serial_gui.getText().isEmpty()&&imgPath==null) {
